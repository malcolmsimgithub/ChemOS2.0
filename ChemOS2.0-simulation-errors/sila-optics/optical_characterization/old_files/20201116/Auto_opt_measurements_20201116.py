...
class Optical_measurements():
    ...
    def __init__(self, TE=True, AbsPL=True, Pump=True, logger = False):
        ...
        self.AP = Abs_PL(led_power=self.abspl_config['PL']['led_power'], correction_datafile= self.abspl_config['data_processing']['correction_datafile'], device=AbsPL)
    ...
    def collect_sample_from_valve(self, sample_volume, collector_num, setting):
        ...
        self.log(f'Draw {sample_volume*1000:.2f} ml of sample')
    ...
    def sample_dilution(self, sample_volume, dilution, setting):
        ...
        self.log(f'Draw {sample_volume*(dilution - 1)*1000:.2f} ml of solvent and mix in vial')
