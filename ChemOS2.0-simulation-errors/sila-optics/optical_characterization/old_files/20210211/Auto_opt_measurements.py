...
if __name__ == '__main__':
    ...
    Opt = Optical_measurements(TE = True, AbsPL = True, Pump = True, logger=True)
    ##############
    ...
    #####initialize#####
    # Opt.draw_and_dispense('ACN', 'flow_cell_PL', 1*ml, draw_velocity=500, dispense_velocity=500)
    # Opt.draw_and_dispense('ACN', 'flow_cell_abs', 1*ml, draw_velocity=500, dispense_velocity=500)
    # Opt.draw_and_dispense('ACN', 'flow_cell', 1*ml, draw_velocity=500, dispense_velocity=500)
    # Opt.vial_wash(0.3*ml, 2)
    # Opt.collector_wash(0.3*ml, 1, 2)
    # Opt.collector_wash(0.3*ml, 1, 3)
    # Opt.collector_wash(0.3*ml, 1, 4)
    # Opt.collector_wash(0.3*ml, 1, 5)
    # Opt.collector_wash(0.3*ml, 1, 8)
    # Opt.collector_wash(0.3*ml, 1, 9)
    # Opt.collector_wash(0.3*ml, 1, 10)
    ...
    path = 'C:/Users/MatterLab/Dropbox/PythonScript/kazu/data/2021_test'
    ...
    Opt.do_measurements(fname, measurements = ['absorption', 'PL','TE'], sample_position = 2, sample_volume = 0.12*ml, dilution = 1, water_ratio = 0, sample_info=sample_info) 
