...
if __name__ == '__main__':
    ...
    # path = 'C:/Users/MatterLab/Dropbox/PythonScript/kazu/data/20201204_test'
    # if os.path.exists(path) == False:
    #    os.mkdir(path)
    # fname = '%s/%s_%s_in_%s_2' %(path, sample_info['concentration(uM)'], sample_info['name'], sample_info['solvent'])
    ...
    # Opt.do_measurements(fname, measurements = ['absorption', 'PL'], sample_position = 2, sample_volume = 0.1*ml, dilution = 1, water_ratio = 0, sample_info=sample_info) 
