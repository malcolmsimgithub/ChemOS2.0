...
from .errors import CannotFindPicoSDKError, CannotOpenPicoSDKError, DeviceNotFoundError, \
...
#   library_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "PS5000a.dll")
#        library_path = 'C:\Program Files\Pico Technology\SDK\lib\ps5000a.dll'
        print(library_path)
