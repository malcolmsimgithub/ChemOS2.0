    ...
    while True:
        ...
        for notified_socket in read_sockets:
            ...
            if notified_socket == server_socket:
                ...
                id = receive_message(client_socket)
            ...
            # Else existing socket is sending a message
                ...
                if message is False:
                    ...
                    try:
                        lostconnection_name = clients[notified_socket]['data'].decode('utf-8')
                        ...
                        for client_socket in clients:
                                message = f"{lostconnection_name}_lost".encode('utf-8')
                                print(f'SOCKET: Sending message to {id["data"].decode("utf-8")}: {message.decode("utf-8")}') 

                                message_header = f"{len(message):<{HEADER_LENGTH}}".encode('utf-8')
                                client_socket.send(id['header'] + id['data'] + message_header + message)
                    except:
                ...
                for client_socket in clients:
                    ...
                    if client_socket != notified_socket:
                        print(f'SOCKET: Sending message to {id["data"].decode("utf-8")}: {message["data"].decode("utf-8")}')
