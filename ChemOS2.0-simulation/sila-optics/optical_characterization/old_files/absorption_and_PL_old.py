...
class Abs_PL():
    ...
    def __init__(self, led_power = 80, correction_datafile = None):
    ...
    def measure_spectrum(self, repeats, integration_time, filter_size = None, dark_correction = True, do_plot = False):
    ...
    def measure_spectrum_trace(self, repeats, integration_time, filter_size = None, dark_correction = True, do_plot = False):
    ...
    def adjust_PL_exposure(self, initial_exposure, max_exposure, target_intensity, led_power, filter_size = 20, average = 5):
        ...
        while saturation:
            ...
            PL_spectrum = self.measure_PL_spectrum(average, initial_exposure, led_power=led_power, filter_size=filter_size, dark_correction=False)
    ...
    def measure_PL_spectrum(self, repeats, integration_time, led_power = 80, filter_size = None, dark_correction = True, spectral_correction = True, do_plot = False):
        ...
        PL_spectrum = self.measure_spectrum(repeats, integration_time, filter_size = filter_size, dark_correction = dark_correction, do_plot = do_plot)

        if spectral_correction:
            PL_spectrum[1] = PL_spectrum[1]/self.correction_data

        return PL_spectrum


    def measure_PL_spectrum2(self, repeats, integration_time, led_power = 80, filter_size = None, dark_correction = True, spectral_correction = True, do_plot = False):
        ...
        def measure_PL(results, flg):
            ...
            if spectral_correction:
               PL_spectrum[1] = PL_spectrum[1]/self.correction_data
            results['PL_spectrum'] = PL_spectrum
            flg['flg'] = False
