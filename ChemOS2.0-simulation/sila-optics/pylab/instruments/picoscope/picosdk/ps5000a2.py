...
from .constants import make_enum


class ps5000a(Library):
    def __init__(self):
        super(ps5000a, self).__init__("ps5000a")

        self.PS5000A_DEVICE_RESOLUTION = make_enum([
            "PS5000A_DR_8BIT",
            "PS5000A_DR_12BIT",
            "PS5000A_DR_14BIT",
            "PS5000A_DR_15BIT",
        ...
        self.DEFAULT_RESOLUTION = self.PS5000A_DEVICE_RESOLUTION["PS5000A_DR_8BIT"]

        self.PS5000A_COUPLING = make_enum([
            'PS5000A_AC',
            'PS5000A_DC',
        ])

        # Just use AC and DC.
        self.PICO_COUPLING = {k[-2:]: v for k, v in self.PS5000A_COUPLING.items()}
        ...
        self.PS5000A_CHANNEL = _define_channel()

        # only include the normal analog channels for now:
        self.PICO_CHANNEL = {k[-1]: v for k, v in self.PS5000A_CHANNEL.items() if "PS5000A_CHANNEL_" in k}

        self.PS5000A_RANGE = make_enum([
            "PS5000A_10MV",
            "PS5000A_20MV",
            "PS5000A_50MV",
            "PS5000A_100MV",
        ...
        self.PS5000A_THRESHOLD_DIRECTION = make_enum([
        ...
        self.PICO_VOLTAGE_RANGE = {
            ...
            for k, v in self.PS5000A_RANGE.items() if k != "PS5000A_MAX_RANGES"
        }

        self.PS5000A_DIGITAL_CHANNEL = make_enum([
        ...
        self.PS5000A_DIGITAL_DIRECTION = make_enum([
        ...
        self.PS5000A_THRESHOLD_MODE = make_enum([
            "PS5000A_LEVEL",
            "PS5000A_WINDOW"
        ])

        self.PS5000A_TRIGGER_STATE = make_enum([
...
# 				("condition", c_int16)]
        ...
        self.make_symbol("_OpenUnit", "ps5000aOpenUnit", c_uint32, [c_void_p, c_char_p, c_int32], doc)
        ...
        self.make_symbol("_OpenUnitAsync", "ps5000aOpenUnitAsync", c_uint32, [c_void_p, c_char_p, c_int32], doc)
        ...
        self.make_symbol("_OpenUnitProgress", "ps5000aOpenUnitProgress", c_uint32, [c_void_p, c_void_p, c_void_p], doc)
        ...
        self.make_symbol("_GetUnitInfo", "ps5000aGetUnitInfo", c_uint32, [c_int16, c_char_p, c_int16, c_void_p, c_uint32],
                            doc)
        ...
        self.make_symbol("_FlashLed", "ps5000aFlashLed", c_uint32, [c_int16, c_int16], doc)
        ...
        self.make_symbol("_IsLedFlashing", "ps5000aIsLedFlashing", c_uint32, [c_int16, c_void_p], doc)

        doc = """ PICO_STATUS ps5000aCloseUnit
            (
                int16_t handle
            ); """
        self.make_symbol("_CloseUnit", "ps5000aCloseUnit", c_uint32, [c_int16, ], doc)
        ...
        self.make_symbol("_MemorySegments", "ps5000aMemorySegments", c_uint32, [c_int16, c_uint32, c_void_p], doc)
        ...
        self.make_symbol("_SetChannel", "ps5000aSetChannel", c_uint32,
        ...
        self.make_symbol("_SetBandwidthFilter", "ps5000aSetBandwidthFilter", c_uint32, [c_int16, c_int32, c_int32], doc)
        ...
        self.make_symbol("_GetTimebase", "ps5000aGetTimebase", c_uint32,
        ...
        self.make_symbol("_GetTimebase2", "ps5000aGetTimebase2", c_uint32,
                            [c_int16, c_uint32, c_int32, c_void_p, c_void_p, c_uint32], doc)
        ...
        self.make_symbol("_SetSigGenArbitrary", "ps5000aSetSigGenArbitrary", c_uint32,
        ...
        self.make_symbol("_SetSigGenBuiltIn", "ps5000aSetSigGenBuiltInV2", c_uint32,
        ...
        self.make_symbol("_SetSigGenPropertiesArbitrary", "ps5000aSetSigGenPropertiesArbitrary", c_uint32,
        ...
        self.make_symbol("_SetSigGenPropertiesBuiltIn", "ps5000aSetSigGenPropertiesBuiltIn", c_uint32,
        ...
        self.make_symbol("_SigGenFrequencyToPhase", "ps5000aSigGenFrequencyToPhase", c_uint32,
        ...
        self.make_symbol("_SigGenArbitraryMinMaxValues", "ps5000aSigGenArbitraryMinMaxValues", c_uint32,
        ...
        self.make_symbol("_SigGenSoftwareControl", "ps5000aSigGenSoftwareControl", c_uint32, [c_int16, c_int16], doc)
        ...
        self.make_symbol("_SetEts", "ps5000aSetEts", c_uint32, [c_int16, c_int32, c_int16, c_int16, c_void_p], doc)
        ...
        self.make_symbol("_SetTriggerChannelProperties", "ps5000aSetTriggerChannelProperties", c_uint32,
        ...
        self.make_symbol("_SetTriggerChannelPropertiesV2", "ps5000aSetTriggerChannelPropertiesV2", c_uint32,
        ...
        self.make_symbol("_SetTriggerChannelConditions", "ps5000aSetTriggerChannelConditions", c_uint32,
        ...
        self.make_symbol("_SetTriggerChannelConditionsV2", "ps5000aSetTriggerChannelConditionsV2", c_uint32,
        ...
        self.make_symbol("_SetTriggerChannelDirections", "ps5000aSetTriggerChannelDirections", c_uint32,
        ...
        self.make_symbol("_SetTriggerChannelDirectionsV2", "ps5000aSetTriggerChannelDirectionsV2", c_uint32,
        ...
        self.make_symbol("_SetSimpleTrigger", "ps5000aSetSimpleTrigger", c_uint32,
        ...
        self.make_symbol("_SetTriggerDelay", "ps5000aSetTriggerDelay", c_uint32, [c_int16, c_uint32], doc)
        ...
        self.make_symbol("_SetPulseWidthQualifier", "ps5000aSetPulseWidthQualifier", c_uint32,
        ...
        self.make_symbol("_IsTriggerOrPulseWidthQualifierEnabled", "ps5000aIsTriggerOrPulseWidthQualifierEnabled", c_uint32,
        ...
        self.make_symbol("_GetTriggerTimeOffset", "ps5000aGetTriggerTimeOffset64", c_uint32,
        ...
        self.make_symbol("_GetValuesTriggerTimeOffsetBulk", "ps5000aGetValuesTriggerTimeOffsetBulk64", c_uint32,
        ...
        self.make_symbol("_SetDataBuffers", "ps5000aSetDataBuffers", c_uint32,
        ...
        self.make_symbol("_SetDataBuffer", "ps5000aSetDataBuffer", c_uint32,
        ...
        self.make_symbol("_SetEtsTimeBuffer", "ps5000aSetEtsTimeBuffer", c_uint32, [c_int16, c_void_p, c_int32], doc)
        ...
        self.make_symbol("_IsReady", "ps5000aIsReady", c_uint32, [c_int16, c_void_p], doc)
        ...
        self.make_symbol("_RunBlock", "ps5000aRunBlock", c_uint32,
        ...
        self.make_symbol("_RunStreaming", "ps5000aRunStreaming", c_uint32,
        ...
        self.make_symbol("_GetStreamingLatestValues", "ps5000aGetStreamingLatestValues", c_uint32,
                            [c_int16, c_void_p, c_void_p], doc)
        ...
        #         void     *pParameter
        #     ); """
        # self.make_symbol("_StreamingReady", "ps5000aStreamingReady", c_void_p,
        ...
        self.make_symbol("_NoOfStreamingValues", "ps5000aNoOfStreamingValues", c_uint32, [c_int16, c_void_p], doc)
        ...
        self.make_symbol("_GetMaxDownSampleRatio", "ps5000aGetMaxDownSampleRatio", c_uint32,
        ...
        self.make_symbol("_GetValues", "ps5000aGetValues", c_uint32,
        ...
        self.make_symbol("_GetValuesAsync", "ps5000aGetValuesAsync", c_uint32,
        ...
        self.make_symbol("_GetValuesBulk", "ps5000aGetValuesBulk", c_uint32,
        ...
        self.make_symbol("_GetValuesOverlapped", "ps5000aGetValuesOverlapped", c_uint32,
                            [c_int16, c_uint32, c_void_p, c_uint32, c_int32, c_uint32, c_void_p], doc)
        ...
        self.make_symbol("_GetValuesOverlappedBulk", "ps5000aGetValuesOverlappedBulk", c_uint32,
        ...
        self.make_symbol("_TriggerWithinPreTriggerSamples", "ps5000aTriggerWithinPreTriggerSamples", c_uint32,
                            [c_int16, c_int32], doc)
        ...
        self.make_symbol("_GetTriggerInfoBulk", "ps5000aGetTriggerInfoBulk", c_uint32,
        ...
        self.make_symbol("_EnumerateUnits", "ps5000aEnumerateUnits", c_uint32, [c_void_p, c_char_p, c_void_p], doc)
        ...
        self.make_symbol("_GetChannelInformation", "ps5000aGetChannelInformation", c_uint32,
        ...
        self.make_symbol("_MaximumValue", "ps5000aMaximumValue", c_uint32, [c_int16, c_void_p], doc)
        ...
        self.make_symbol("_MinimumValue", "ps5000aMinimumValue", c_uint32, [c_int16, c_void_p], doc)
        ...
        self.make_symbol("_GetAnalogueOffset", "ps5000aGetAnalogueOffset", c_uint32,
        ...
        self.make_symbol("_GetMaxSegments", "ps5000aGetMaxSegments", c_uint32, [c_int16, c_void_p], doc)
        ...
        self.make_symbol("_ChangePowerSource", "ps5000aChangePowerSource", c_uint32, [c_int16, c_uint32], doc)

        doc = """ PICO_STATUS ps5000aCurrentPowerSource
            (
                int16_t handle
            ); """
        self.make_symbol("_CurrentPowerSource", "ps5000aCurrentPowerSource", c_uint32, [c_int16, ], doc)

        doc = """ PICO_STATUS ps5000aStop
            (
                int16_t  handle
            ); """
        self.make_symbol("_Stop", "ps5000aStop", c_uint32, [c_int16, ], doc)

        doc = """ PICO_STATUS ps5000aPingUnit
            (
                int16_t  handle
            ); """
        self.make_symbol("_PingUnit", "ps5000aPingUnit", c_uint32, [c_int16, ], doc)
        ...
        self.make_symbol("_SetNoOfCaptures", "ps5000aSetNoOfCaptures", c_uint32, [c_int16, c_uint32], doc)
        ...
        self.make_symbol("_GetNoOfCaptures", "ps5000aGetNoOfCaptures", c_uint32, [c_int16, c_void_p], doc)
        ...
        self.make_symbol("_GetNoOfProcessedCaptures", "ps5000aGetNoOfProcessedCaptures", c_uint32, [c_int16, c_void_p], doc)
        ...
        self.make_symbol("_SetDeviceResolution", "ps5000aSetDeviceResolution", c_uint32, [c_int16, c_int32], doc)
        ...
        self.make_symbol("_GetDeviceResolution", "ps5000aGetDeviceResolution", c_uint32, [c_int16, c_void_p], doc)
        ...
        self.make_symbol("_SetDigitalPort", "ps5000aSetDigitalPort", c_uint32, [c_int16, c_int32, c_int16, c_int16], doc)
        ...
        self.make_symbol("_SetPulseWidthDigitalPortProperties", "ps5000aSetPulseWidthDigitalPortProperties", c_uint32,
                            [c_int16, c_void_p, c_int16], doc)
        ...
        self.make_symbol("_SetTriggerDigitalPortProperties", "ps5000aSetTriggerDigitalPortProperties", c_uint32,
                            [c_int16, c_void_p, c_int16], doc)
