...
class HPLCSimulator(object):
    ...
    def _wait_for_input(self) -> None:
        """
        Constantly checks the input directory for a new job (submitted as a pkl file with the structure defined by
        Kazu & Tony). Sets the _current_job attribute with the measurement details dictionary.
        """
        while True:
    ...
    def _data_analysis(self) -> None:
        ...
        print(f"job {self._current_job['name']} has been completed.")
