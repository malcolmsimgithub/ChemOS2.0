...
in
  mkShell { buildInputs = with python310Packages; [ notification-apps periodictable sila2 packaging streamlit singleton-decorator python-telegram-bot tkinter pandas typer gpytorch botorch matter-chimera matter-golem olympus atlas molar psycopg2 pyunpack patool redis];
