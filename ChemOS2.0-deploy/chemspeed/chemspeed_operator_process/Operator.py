...
class ChemSpeedOperator(object):
    ...
    def __init__(
        ...
        self.executor = ChemSpeedExecutor(
            ...
            hplc_controller=self.hardware["hplc"],
    ...
    def _setup_folders(
        ...
        paths = {
            ...
            "output": parent_dir,
            "synthesis": os.path.join(parent_dir,"Synthesis"),
            "batches_to_make": os.path.join(parent_dir,"Synthesis/Batches_to_Make"),
            "completed_batches": os.path.join(parent_dir,"Synthesis/Completed_Batches"),
            "characterization": os.path.abspath(os.path.join(parent_dir,"Characterization")),
            "modules": os.path.join(parent_dir,"ChemSpeed_Modules"),
            "storage": os.path.join(parent_dir, "Storage_Inventory"),
        }
    ...
    def _run_operation(
        ...
        available_operations = {
            ...
            "submit_hplc_job": self.hardware["hplc"].submit_hplc_job,
