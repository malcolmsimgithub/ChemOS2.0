...
from .chemspeedoperator import ChemSpeedOperatorClient


class Client(SilaClient):

    ChemSpeedOperator: ChemSpeedOperatorClient
    ...
    _expected_features: Set[FullyQualifiedFeatureIdentifier] = {
        ...
        FullyQualifiedFeatureIdentifier("org.silastandard/examples/ChemSpeedOperator/v1"),
    }
