...
class PowerManager():
    ...
    def __init__(self):
        ...
        self.dev_list = {
            ...
            'DC4100' : {'PowerUSB' : 2, 'port' : 1, 'measurement' : 'AbsPL'}, #LED driver
            'KSC101' : {'PowerUSB' : 2, 'port' : 2, 'measurement' : 'AbsPL'}, #shutter controller
            'DH-MINI' : {'PowerUSB' : 2, 'port' : 3, 'measurement' : 'AbsPL'}, #D2/Halogen lamp
            'APD' : {'PowerUSB' : 1, 'port' : 1, 'measurement' : 'TE'}, #avalanche photo diode
            'PDL800D' : {'PowerUSB' : 1, 'port' : 2, 'measurement' : 'TE'}, #pico-sec laser driver
            'GSC02' : {'PowerUSB' : 1, 'port' : 3, 'measurement' : 'TA'} #sigma stage driver
        }
