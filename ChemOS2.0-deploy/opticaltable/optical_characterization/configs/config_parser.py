...
class ConfigParser():
	...
	def _parse(self, provided_settings):
		...
		self.washing = Configuration('washing')
		for key, value in provided_settings['washing'].items():
			self.washing.add_attr(key, value)
	...
	@property
	def abs_equilibration_time(self):
		return self.absorption.abs_equilibration_time
	...
	@property
	def PL_equilibration_time(self):
		return self.PL.PL_equilibration_time
	...
	@property
	def cell_washing_volume(self):
		return self.washing.flow_cells_volume

	@property
	def cell_washing_repeat(self):
		return self.washing.flow_cells_repeat

	@property
	def dilution_vial_washing_volume(self):
		return self.washing.dilution_vial_volume

	@property
	def dilution_vial_washing_repeat(self):
		return self.washing.dilution_vial_repeat

	@property
	def collection_vial_washing_volume(self):
		return self.washing.collection_vial_volume

	@property
	def collection_vial_washing_repeat(self):
		return self.washing.collection_vial_repeat
	...
	@property
	def data_path_result_output(self):
		return self.data_path.result_output
